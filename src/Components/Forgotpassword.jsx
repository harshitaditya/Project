    ...
    <>
      ...
      <div className="bg-[#135887] min-h-screen pt-20 grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8 items-center px-4 sm:px-6 lg:px-10">
        ...
        <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-lg w-full max-w-md sm:max-w-lg lg:max-w-2xl mx-auto lg:mx-0">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center text-gray-800 mb-2 pt-2 sm:pt-10 lg:pt-20">
            Lets Help You out!
          </h1>
              ...
              <div className="flex gap-4">
                {onBack && (
                  <button
                    type="button"
                    onClick={onBack}
                    className="cursor-pointer bg-gray-500 text-white py-2 sm:py-3 px-4 sm:px-6 lg:px-8 rounded-lg hover:bg-gray-600 transition-colors duration-200 font-bold text-lg sm:text-xl lg:text-2xl"
                  >
                    Back to Login
                  </button>
                )}
                <button
                  type="submit"
                  disabled={ispending}
                  className={`cursor-pointer bg-[#3396D3] text-white py-2 sm:py-3 px-4 sm:px-6 lg:px-8 rounded-lg transition-colors duration-200 font-bold text-lg sm:text-xl lg:text-2xl ${
                    ispending
