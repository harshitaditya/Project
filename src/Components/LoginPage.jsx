    ...
    <>
      ...
      <div className="bg-[#135887] min-h-screen pt-20 grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8 items-center px-4 sm:px-6 lg:px-10">
        ...
        <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-lg w-full max-w-md sm:max-w-lg lg:max-w-2xl mx-auto lg:mx-0">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center text-gray-800 mb-2 pt-4 sm:pt-10 lg:pt-20">
            Hello Again!
          </h1>
          ...
          <form action={formAction} className="space-y-4">
            ...
            <div className="flex justify-end">
              <button
                ...
                className="text-blue-500 text-base sm:text-lg lg:text-2xl cursor-pointer underline font-bold"
              >
                Forgot Password
              </button>
            </div>
